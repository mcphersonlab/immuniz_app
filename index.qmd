---
title: "Immunization Scheduler (All Ages)"
subtitle: "AAP/ACIP Recommended Vaccine Schedule for Pediatric and Adult Patients"
format:
  html:
    page-layout: full
    css: styles.css
  ...
  <div id="patient-sidebar" class="col-md-4 col-xl-3">
    <div class="card shadow-sm position-sticky" style="top:1rem;">
      ...
      <div class="card-body">
        ...
        <div class="row g-2">
          ...
          <div class="col-6">
            <div class="form-check">
              ...
              <label class="form-check-label" for="c-asthma">Asthma or recurrent wheezing (especially &lt; 5 yrs, or on systemic steroids)</label>
            </div>
          </div>
        ...
        <!-- Sub-section: Influenza-Specific Factors -->
        <p class="fw-semibold text-secondary small mb-1 mt-2">Influenza-Specific Factors</p>
        <div class="row g-2">

          <div class="col-12">
            <div class="form-check">
              <input class="form-check-input contra" type="checkbox" id="c-flu-first-time" value="flu-first-time" />
              <label class="form-check-label" for="c-flu-first-time">First-time influenza vaccination (patient &lt; 9 years)</label>
            </div>
          </div>

        </div><!-- /influenza-specific row -->
