...
subtitle: "ACIP Recommended Vaccine Schedule for Pediatric and Adult Patients"
format:
  html:
    page-layout: full
    css: styles.css
    ...
    <div class="row">
      <div class="col-12">
        <div class="alert alert-secondary small">
          ...
          <a href="https://www.cdc.gov/vaccines/schedules/" target="_blank">ACIP recommended immunization schedule for children, adolescents, and adults</a>.
          It does not replace clinical judgment or real-time CDC/ACIP/AAP guidelines. Always verify doses already given,
