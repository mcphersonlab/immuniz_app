        ...
        <div class="card-body">
          <div class="row g-3">
            ...
            <div class="col-md-6 d-flex align-items-end">
              <button id="calculate-btn" class="btn btn-primary me-2">
                &#128269; Calculate Schedule
              </button>
          ...
          <!-- Contraindications -->
          <hr class="my-3" />
          <h6 class="fw-semibold mb-3">&#9888;&#65039; Contraindication &amp; Precaution Screening</h6>
          <div class="row g-2">

            <div class="col-md-4 col-lg-3">
              <div class="form-check">
                <input class="form-check-input contra" type="checkbox" id="c-allergy-egg" value="allergy-egg" />
                <label class="form-check-label" for="c-allergy-egg">Egg allergy (severe / anaphylaxis)</label>
              </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3">
              <div class="form-check">
                ...
                <label class="form-check-label" for="c-allergy-gelatin">Gelatin allergy</label>
              </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3">
              <div class="form-check">
                ...
                <label class="form-check-label" for="c-allergy-neomycin">Neomycin allergy</label>
              </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3">
              <div class="form-check">
                ...
                <label class="form-check-label" for="c-allergy-yeast">Yeast (Saccharomyces) allergy</label>
              </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3">
              <div class="form-check">
                ...
                <label class="form-check-label" for="c-prev-reaction">Severe allergic reaction to prior dose of this vaccine</label>
              </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3">
              <div class="form-check">
                ...
                <label class="form-check-label" for="c-latex">Latex allergy (for vials with latex stoppers)</label>
              </div>
            </div>
...
const SCHEDULE = [
  ...
  // IPV
  {
    ...
    contraindications: ['prev-reaction', 'allergy-neomycin', 'allergy-streptomycin', 'allergy-polymyxin-b'],
    precautions: [],
    liveVaccine: false,
    riskBased: false
  },
...
function computeSchedule(ageDays) {
  const selectedContra = getSelectedContra();
...
// ── Render ─────────────────────────────────────────────────────────
function renderTable(tbodyId, rows, columns, emptyId) {
...
function renderResults(ageDays) {
  ...
  renderTable('recommended-now-body', recommended,
    ['vaccine', 'series', 'notes'], 'no-recommended');

  renderTable('catchup-body', catchup,
    ['vaccine', 'series', 'notes'], 'no-catchup');
  ...
  if (contraItems.length === 0) {
    ...
    contraItems.forEach(item => {
      const tr = document.createElement('tr');
      const badgeClass = item.type === 'Contraindication' ? 'bg-danger' : 'bg-warning text-dark';
      tr.innerHTML = `<td>${item.vaccine} (${item.abbr})</td>
  ...
  renderTable('risk-body', riskBased,
    ['vaccine', 'series', 'indication'], 'no-risk');
...
document.getElementById('calculate-btn').addEventListener('click', function () {
  ...
  if (dob) {
    ...
    const val  = parseFloat(document.getElementById('age-value').value);
    const unit = document.getElementById('age-unit').value;
    if (isNaN(val) || val < 0) {
      alert('Please enter a valid age or date of birth.');
      return;
    }
...
// Allow Enter key on age input to trigger calculate
