        ...
        <div class="row g-2">
          ...
          <div class="col-12">
            <div class="form-check">
              ...
              <label class="form-check-label" for="c-flu-first-time">First-time influenza vaccination (child &lt; 9 years)</label>
            </div>
          </div>
...
const SCHEDULE = [
  ...
  // Influenza (IIV/ccIIV)
  {
    ...
    catchupMinDays: toDays(6, 'months'),
    catchupMaxDays: toDays(18, 'years'),
    notes: "Preferred when LAIV is contraindicated (egg allergy, asthma/recurrent wheezing, immunocompromised, first-time vaccination < 9 yrs). Two doses (4 weeks apart) in first season if < 9 years and not previously vaccinated. Severe egg allergy: use ccIIV4 or RIV4.",
    contraindications: ['prev-reaction'],
  ...
  },
  {
    ...
    catchupMaxDays: toDays(18, 'years'),
    notes: "Alternative (intranasal) option for healthy, non-pregnant children ≥ 2 years, or when patient strongly prefers intranasal route (needle avoidance). Avoid in: first-time vaccination (< 9 yrs), egg allergy, asthma or recurrent wheezing (especially < 5 yrs), and immunocompromising conditions.",
