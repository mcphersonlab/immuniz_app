...
const SCHEDULE = [
  ...
  },
  {
    ...
    abbr: "LAIV4",
    series: "Annual (preferred ≥ 2 yrs when eligible)",
    minAgeDays: toDays(2, 'years'),
    maxAgeDays: toDays(18, 'years'),
    catchupMinDays: toDays(2, 'years'),
    catchupMaxDays: toDays(18, 'years'),
    notes: "Preferred for healthy, non-pregnant children ≥ 2 years, or when patient strongly prefers intranasal route (needle avoidance). Avoid in: first-time vaccination (< 9 yrs), egg allergy, asthma or recurrent wheezing (especially < 5 yrs), and immunocompromising conditions.",
